...
class Generator_CNN(nn.Module):
    ...
    def __init__(self, latent_dim, x_shape, verbose=False):
        ...
        self.ishape_img_size = int(x_shape[1] / 4) # 7 for MNIST and 8 for CIFAR10
        self.ishape = (128, self.ishape_img_size, self.ishape_img_size)
...
class Encoder_CNN(nn.Module):
    ...
    """
    def __init__(self, latent_dim, verbose=False, channels=1, x_shape=(1, 28, 28)):
        ...
        self.latent_dim = latent_dim
        # self.n_c = n_c
        img_shape_1 = int(((x_shape[1] - 4) / 2.0) + 1)
        img_shape_2 = int(((img_shape_1 - 4) / 2.0) + 1)  
        self.cshape = (128, img_shape_2, img_shape_2)
...
class Discriminator_CNN(nn.Module):
    ...
    def __init__(self, wass_metric=False, verbose=False, channels=1, x_shape=(1, 28, 28)):
