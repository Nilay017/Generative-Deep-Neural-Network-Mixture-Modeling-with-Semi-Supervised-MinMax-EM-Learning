...
def main():
    ...
    # mean = torch.mean(cluster_centers, 0)
    ...
    for epoch in range(n_epochs):
        ...
        for i, (imgs, itruth_label) in enumerate(dataloader):
            ...
            z = sample_z(shape=imgs.shape[0], latent_dim=latent_dim, n_c=num_clusters, fix_class=0, cluster_centers=cluster_centers, req_grad=False)
