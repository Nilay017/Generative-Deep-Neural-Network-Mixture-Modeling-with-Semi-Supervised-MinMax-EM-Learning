...
def main():
    ...
    #change
    parser.add_argument("-r", "--run_name", dest="run_name", default='retinopathy_pretrain_clusgan_3_all', help="Name of training run")
    ...
    # python3 retinopathy_initialize_em_clusgan.py -n 400 -g 0 -sup 0.5 -seed 0.0
    ...
    sep_und = '_'
    run_name_comps = ['retinopathy_pretraining_supervision_%f_'%supervision_level,'epoch_%i_'%n_epochs, '_', mtype, '_', time_stamp, '_', 'seed_%i_'%seed, run_name]
    ...
    # Training loop 
    #change
    log_final_results = open("pretrain_clusgan_retinopathy_3_all_digits_semi_sup_" + str(supervision_level) + "_seed_" + str(seed), "a+")
