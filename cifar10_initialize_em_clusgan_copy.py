...
def main():
    ...
    #change
    parser.add_argument("-r", "--run_name", dest="run_name", default='cifar10_pretrain_clusgan_7_all', help="Name of training run")
    ...
    #change
    datafile_path = "./Output_data_processing/CIFAR10_kmeans_clustering_data_7_" + str(given_supervision_level) + "_seed_" + str(int(seed)) + ".pkl"
    ...
    time_stamp = datetime.datetime.fromtimestamp(time.time()).strftime('%m-%d-%H')
    # time_stamp = '11-18-01-27'
    sep_und = '_'
    run_name_comps = ['cifar10_pretraining_supervision_%f_'%supervision_level,'epoch_%i_'%n_epochs, '_', mtype, '_', time_stamp, '_', 'seed_%i_'%seed, run_name]
    ...
    # Training loop 
    #change
    log_final_results = open("pretrain_clusgan_CIFAR_7_all_digits_semi_sup_" + str(supervision_level) + "_seed_" + str(seed), "a+")
