...
def main():
    ...
    #change
    parser.add_argument("-r", "--run_name", dest="run_name", default='noisy_cifar10_pretrain_clusgan_5_all', help="Name of training run")
    ...
    # python3 initialize_em_clusgan.py -n 300 -g 0 -sup 0.0 -seed 1.0
    # python3 initialize_em_clusgan.py -n 300 -g 0 -sup 0.0 -seed 0.0
    # python3 cifar10_initialize_em_clusgan.py -n 300 -g 0 -sup 0.5 -seed 0.0
    # python3 cifar10_initialize_em_clusgan_noisy.py -n 400 -g 6 -sup 0.0 -seed 0.0
    ...
    sep_und = '_'
    # Change
    run_name_comps = ['noisy_cifar10_pretraining_supervision_%f_'%supervision_level,'epoch_%i_'%n_epochs, '_', mtype, '_', time_stamp, '_', 'seed_%i_'%seed, run_name]
    ...
    # Training loop 
    #change
    log_final_results = open("noisy_pretrain_clusgan_CIFAR_5_all_digits_semi_sup_" + str(supervision_level) + "_seed_" + str(seed), "a+")
