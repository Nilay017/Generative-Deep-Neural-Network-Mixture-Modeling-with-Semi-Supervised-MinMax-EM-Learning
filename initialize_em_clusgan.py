...
def main():
    ...
    sep_und = '_'
    run_name_comps = ['pretraining_supervision_%f_'%supervision_level,'epoch_%i_'%n_epochs, '_', mtype, '_', time_stamp, '_', 'seed_%i_'%seed, run_name]
    ...
    # Training loop 
    log_final_results = open("pretrain_clusgan_MNIST_7_all_digits_semi_sup_" + str(supervision_level) + "_seed_" + str(seed), "a+")
