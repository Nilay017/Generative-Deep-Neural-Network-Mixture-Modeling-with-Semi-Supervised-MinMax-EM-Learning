...
def main():
    ...
    #change
    parser.add_argument("-r", "--run_name", dest="run_name", default='cifar10_pretrain_clusgan_5_all', help="Name of training run")
    ...
    # Training loop 
    #change
    log_final_results = open("pretrain_clusgan_CIFAR_5_all_digits_semi_sup_" + str(supervision_level) + "_seed_" + str(seed), "a+")
