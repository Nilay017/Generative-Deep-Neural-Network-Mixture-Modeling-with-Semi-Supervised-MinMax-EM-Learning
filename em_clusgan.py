...
parser.add_argument("-r", "--run_name", dest="run_name", default='pretrain_clusgan_5_all', help="Name of training run")
...
def run_main(seed):
    # python3 em_clusgan.py -n 300 -g 0 -sup 0.0 -seed 1.0
    global args
    ...
    datafile_path = "./Output_data_processing/kmeans_clustering_data_5_" + str(given_supervision_level) + "_seed_" + str(int(seed)) + ".pkl"
    ...
    model_loadpath += "__epoch_300____van___11-26-14___seed_" + str(int(seed)) + "__pretrain_clusgan_5_all/models/"
    ...
    log_final_results = open("train_clusgan_MNIST_5_digits_semi_sup_" + str(supervision_level) + "_seed_" + str(seed), "a+")
...
if __name__ == "__main__":
    ...
    log_final_results_metrics = open("metrics_train_clusgan_MNIST_5_digits_semi_sup_" + str(args.supervision_level), "a+")
    ...
    pkl.dump(final_dict, open( './new_final_dict_5_' + str(args.supervision_level) + '_seed_' + str(seed) + '.pkl', "wb"), protocol=pkl.HIGHEST_PROTOCOL)
    print("Dumping into  ./new_final_dict_5_" + str(args.supervision_level) + '_seed_' + str(seed) + ".pkl")